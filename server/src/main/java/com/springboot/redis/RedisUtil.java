...
public class RedisUtil {
    ...
    public void setAccessToken(Long userId, String accessToken, long duration) {
        ValueOperations<String, Object> valueOps = redisTemplate.opsForValue();
        Duration expireDuration = Duration.ofSeconds(duration);
        valueOps.set(String.valueOf(userId), accessToken, expireDuration);  // Long을 String으로 변환하여 저장
    }

    public String getAccessToken(Long userId) {
        ValueOperations<String, Object> valueOps = redisTemplate.opsForValue();
        return (String) valueOps.get(String.valueOf(userId));  // Long을 String으로 변환하여 검색
    }
}
